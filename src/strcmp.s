...
strcmp_loop:
    ...
    jz       check_char_null            ; compares byte[rsi] its EQUALS to 0,
    ...
    jne      strcmp_does_not_equal      ; jump if char is not the same
    inc     rsi                         ; src character move 1 char ->
    inc     rdi                         ; dst character move 1 char ->
    jmp     strcmp_loop                 ; Continue looping
